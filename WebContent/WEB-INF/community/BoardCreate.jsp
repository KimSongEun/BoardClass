    	...
    	<div class="row">
    		<div class="column_title">
					...
					<div class="column_category">
						 ...
						 <input type="text" name="title" class="boardtitle" placeholder="제목을 입력해주세요" required="required">
		          ...
		          <div class="col_c" style="margin-bottom: 30px; width: 70%">
		                <div class="input-group">                 
		                  ...
		                  CKFinder.setupCKEditor(p_content);
		                  </script>
		                </div>
		            </div> 
			<button class='movelist list' value='등록' type="submit">등록</button>
			<button class='movelist list' onclick="if(confirm('게시글 작성을 취소하시겠습니까?')){window.close()}else{}" >취소</button>
	</div>	
</form>
