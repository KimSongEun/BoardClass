...
<div class="conwrap">
	...
	<span class="depth">커뮤니티     > </span><strong class="this">글 수정</strong>
	</div>
	</div>
			...
			<c:if test="${category=='유저정보게시판'}"> 
	          ...
	          <div class="col_c" style="margin-bottom: 30px; width: 70%">
	                <div class="input-group">                 
	                  <textarea class="form-control" name="content" id="p_content"  required="required">${board.boardContent}</textarea>
