	...
	<div class="div_paging_before">
			<div id="page" class="div_paging">
				<%
					if (startPage > 1) {
				%>
				<a href="GameStrategyList?pagenum=${startPage-1}" class="pageprevious">&laquo;</a>
				<%
					} else {
				%>
				<a href="GameStrategyList?pagenum=1" class="pageprevious">&laquo;</a>
				<%	}
				...
				%>
				<a href="GameStrategyList?pagenum=${endPage+1}" class="pagenext">&raquo;</a>
				<%
					} else {
				%>
				<a href="GameStrategyList?pagenum=${pageCount}" class="pagenext">&raquo;</a>
				<% } %>
			</div>
		</div>
