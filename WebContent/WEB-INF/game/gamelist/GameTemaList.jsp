		...
		<div class="div_paging_before">
			<div id="page" class="div_paging">
				<%
					if (startPage > 1) {
				%>
				<a href="GameTemaList?pagenum=${startPage-1}" class="pageprevious">&laquo;</a>
				<%
					} else {
				%>
				<a href="GameTemaList?pagenum=1" class="pageprevious">&laquo;</a>
				<%	}
					for (int i = startPage; i <= endPage; i++) {
				%>
				<a href="GameTemaList?pagenum=<%=i%>" class="pagecurrent"> <%=i%></a>
				<%
					}
					if (endPage < pageCount) {
				%>
				<a href="GameTemaList?pagenum=${endPage+1}" class="pagenext">&raquo;</a>
				<%
					} else {
				%>
				<a href="GameTemaList?pagenum=${pageCount}" class="pagenext">&raquo;</a>
				<% } %>
			</div>
		</div>
