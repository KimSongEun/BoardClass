...
<section>
	<div class="tab">
            <button class="tablinks" onclick="openIdPwd(event, 'Id')" >아이디 찾기</button>
            <button class="tablinks" onclick="openIdPwd(event, 'Password')" id="defaultOpen">비밀번호 찾기</button>
    </div>

	      
 		<div id="Id" class="tabcontent">
            <h1>아이디 찾기</h1>
            <form name="formId" method="post" id="searchIdform" action="searchpwd.do">
                <table>
                    <tr>
                        <td class="id1"> 이름</td>
                    ...
                    <tr>
                        ...
                        <td class="id2"><input type="text" name="userPhone" id="userPhone" class="form-control"
