...
<%@include file="/WEB-INF/index/header.jsp"%>
	...
	<section>
		<div class="article_create">
			<form class="form_create" action="usedcreate" method="post" enctype="multipart/form-data">
				<div class="div_table">
					<table>
						<tr class="tr_img">
				...
				<div class="div_info">
					...
					<textarea id="info" name="usedInfo" placeholder="상품정보를 입력하세요" autofocus></textarea>
					<div id="info_count">(0 / 1,000)</div>
				</div>
				<div class="div_keyword">
					<input class="input_keyword" type="text" id="searchresult" value="" placeholder="#검색어" readonly>
				</div>
				<div class="div_search">
					<label for="search" class="label_down">함께 저장할 게임을 검색해주세요!</label>
				...
				<div class="div_button">
					<button class="btn_button" type="submit" onclick="return checkValAll();">등록</button>
				</div>
			</form>
