...
/**
 * Servlet implementation class MyTradeServlet
 */
@WebServlet("/mytrade")
public class MyTradeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		bCount2 = new MyPageService().getMyLikeTradeListCount(userId);
		...
		ArrayList<Used> volist = new MyPageService().myTradeList(userId, startRnum, endRnum);
		...
		ArrayList<UserMyUsed> volist2 = new MyPageService().myLikeTradeList(userId, startRnum2, endRnum2);
		...
		request.getRequestDispatcher("/WEB-INF/mypage/myUsedList.jsp").forward(request, response);
	}
