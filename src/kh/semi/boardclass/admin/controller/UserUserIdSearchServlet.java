...
public class UserUserIdSearchServlet extends HttpServlet {
     ...
     */
    public UserUserIdSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		aCount = new AdminService().getAdminUserUserIdCount(keyword);
		...
		ArrayList<AdminUser> volist  = new AdminService().searchAdminUserUserId(keyword, startRnum, endRnum);
