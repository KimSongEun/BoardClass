...
/**
 * Servlet implementation class AdminMainCommentDeleteServlet
 */
@WebServlet("/adminmaincommentdelete")
public class AdminMainCommentDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminMainCommentDeleteServlet() {
        super();
