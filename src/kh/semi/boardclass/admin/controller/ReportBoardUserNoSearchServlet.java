...
/**
 * Servlet implementation class ReportBoardUserNoSearchServlet
 */
@WebServlet("/reportboardusernosearch")
public class ReportBoardUserNoSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReportBoardUserNoSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		aCount = new AdminService().getReportBoardUserNoCount(keyword);
		...
		ArrayList<ReportBoard> volist  = new AdminService().searchReportBoardUserNo(keyword, startRnum, endRnum);
