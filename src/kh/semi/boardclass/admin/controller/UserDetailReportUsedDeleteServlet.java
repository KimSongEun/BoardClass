...
/**
 * Servlet implementation class UserDetailReportUsedDeleteServlet
 */
@WebServlet("/userdetailreportuseddelete")
public class UserDetailReportUsedDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UserDetailReportUsedDeleteServlet() {
        super();
