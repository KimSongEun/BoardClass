...
/**
 * Servlet implementation class ReportUsedUserIdSearchServlet
 */
@WebServlet("/reportuseduseridsearch")
public class ReportUsedUserIdSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReportUsedUserIdSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		aCount = new AdminService().getReportUsedUserIdCount(keyword);
		...
		ArrayList<ReportUsed> volist  = new AdminService().searchReportUsedUserId(keyword, startRnum, endRnum);
