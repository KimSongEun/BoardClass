...
/**
 * Servlet implementation class UserDetailReportBoardDeleteServlet
 */
@WebServlet("/userdetailreportboarddelete")
public class UserDetailReportBoardDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UserDetailReportBoardDeleteServlet() {
        super();
