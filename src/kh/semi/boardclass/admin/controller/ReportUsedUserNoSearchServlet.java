...
/**
 * Servlet implementation class ReportUsedUserNoSearchServlet
 */
@WebServlet("/reportusedusernosearch")
public class ReportUsedUserNoSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReportUsedUserNoSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		aCount = new AdminService().getReportUsedUserNoCount(keyword);
		...
		ArrayList<ReportUsed> volist  = new AdminService().searchReportUsedUserNo(keyword, startRnum, endRnum);
