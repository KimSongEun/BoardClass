...
/**
 * Servlet implementation class AdminMainUsedDeleteServlet
 */
@WebServlet("/adminmainuseddelete")
public class AdminMainUsedDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminMainUsedDeleteServlet() {
        super();
