...
/**
 * Servlet implementation class AllBoardUserIdSearchServlet
 */
@WebServlet("/allboarduseridsearch")
public class AllBoardUserIdSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AllBoardUserIdSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		aCount = new AdminService().getAllBoardUserIdCount(keyword);
		...
		ArrayList<AllBoardUser> volist  = new AdminService().searchAllBoardUserIdList(keyword, startRnum, endRnum);
