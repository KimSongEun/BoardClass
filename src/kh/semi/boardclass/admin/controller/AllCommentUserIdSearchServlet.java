...
/**
 * Servlet implementation class AllCommentUserIdSearchServlet
 */
@WebServlet("/allcommentuseridsearch")
public class AllCommentUserIdSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AllCommentUserIdSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		aCount = new AdminService().getAllCommentUserIdCount(keyword);
		...
		ArrayList<AllCommentUser> volist  = new AdminService().searchAllCommentUserId(keyword, startRnum, endRnum);
