...
/**
 * Servlet implementation class ReportReviewListServlet
 */
@WebServlet("/reportreviewlist")
public class ReportReviewListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReportReviewListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String selectno = "reportreviewlist";
		int PAGE_SIZE;
		if(viewcount != null) {
		...
		ArrayList<ReportReview> volist  = new AdminService().selectReportReviewList(startRnum, endRnum);
