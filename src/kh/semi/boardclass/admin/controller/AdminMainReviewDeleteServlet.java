...
/**
 * Servlet implementation class AdminMainReviewDeleteServlet
 */
@WebServlet("/adminmainreviewdelete")
public class AdminMainReviewDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminMainReviewDeleteServlet() {
        super();
