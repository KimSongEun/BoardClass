...
/**
 * Servlet implementation class BoardgameSearchServlet
 */
@WebServlet("/boardgamesearch")
public class BoardgameSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoardgameSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		aCount = new AdminService().getBoardGameSearchCount(keyword);
		...
		ArrayList<Game> volist  = new AdminService().searchBoardGame(keyword, startRnum, endRnum);
