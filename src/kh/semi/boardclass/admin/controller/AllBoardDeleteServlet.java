 ...
 */
@WebServlet("/allboarddelete")
public class AllBoardDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AllBoardDeleteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (result > 0) {
			...
			request.setAttribute("loc", "allboardlist");
			RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/admin/allboard/allboardalert.jsp");
