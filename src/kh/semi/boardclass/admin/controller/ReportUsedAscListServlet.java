...
/**
 * Servlet implementation class ReportUsedAscListServlet
 */
@WebServlet("/reportusedasclist")
public class ReportUsedAscListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReportUsedAscListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String selectno = "reportusedasclist";
		int PAGE_SIZE;
		if(viewcount != null) {
		...
		ArrayList<ReportUsed> volist  = new AdminService().selectReportUsedAscList(startRnum, endRnum);
