...
/**
 * Servlet implementation class ReportCommentUserNoSearchServlet
 */
@WebServlet("/reportcommentusernosearch")
public class ReportCommentUserNoSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReportCommentUserNoSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		aCount = new AdminService().getReportCommentUserNoCount(keyword);
		...
		ArrayList<ReportComment> volist  = new AdminService().searchReportCommentUserNo(keyword, startRnum, endRnum);
