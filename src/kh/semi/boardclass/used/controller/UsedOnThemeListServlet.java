...
@WebServlet("/UsedOnThemeList")
public class UsedOnThemeListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public UsedOnThemeListServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/WEB-INF/used/usedonthemelist.jsp").forward(request, response);
