...
@WebServlet("/UsedOnFamilyList")
public class UsedOnFamilyListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public UsedOnFamilyListServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/WEB-INF/used/usedonfamilylist.jsp").forward(request, response);
