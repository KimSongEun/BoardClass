...
@WebServlet("/UsedOnAbstractList")
public class UsedOnAbstractListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public UsedOnAbstractListServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/WEB-INF/used/usedonabstractlist.jsp").forward(request, response);	}
