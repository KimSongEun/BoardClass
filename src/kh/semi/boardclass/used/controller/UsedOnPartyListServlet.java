...
@WebServlet("/UsedOnPartyList")
public class UsedOnPartyListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public UsedOnPartyListServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/WEB-INF/used/usedonpartylist.jsp").forward(request, response);
