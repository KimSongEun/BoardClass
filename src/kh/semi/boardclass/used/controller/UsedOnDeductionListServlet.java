...
@WebServlet("/UsedOnDeductionList")
public class UsedOnDeductionListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public UsedOnDeductionListServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/WEB-INF/used/usedondeductionlist.jsp").forward(request, response);
	}
