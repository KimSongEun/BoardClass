...
@WebServlet("/UsedOnKoreanList")
public class UsedOnKoreanListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public UsedOnKoreanListServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/WEB-INF/used/usedonkoreanlist.jsp").forward(request, response);
