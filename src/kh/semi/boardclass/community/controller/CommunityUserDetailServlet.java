...
/**
 * Servlet implementation class CommunityUserDetailServlet
 */
@WebServlet("/cudetail")
public class CommunityUserDetailServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CommunityUserDetailServlet() {
        super();
...
//		request.setAttribute("content", content);
		...
		request.getRequestDispatcher("/WEB-INF/community/UserBoard/UserBoardContent.jsp").forward(request, response);
	}
