...
public class SearchGathringBoardTitleServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		aCount = new CommunityService().gatheringBoardTitleCount(keyword);
		...
		ArrayList<Board> list  = new CommunityService().gatheringBoardSearchTitle(keyword, startRnum, endRnum);
