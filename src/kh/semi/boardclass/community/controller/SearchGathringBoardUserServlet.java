...
public class SearchGathringBoardUserServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totCnt = new CommunityService().gatheringBoardUserIdCount(keyword);
		...
		ArrayList<Board> list  = new CommunityService().gatheringBoardSearchUserId(keyword, startRow, endRow);
