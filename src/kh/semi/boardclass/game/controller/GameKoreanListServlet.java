 ...
 */
@WebServlet("/GameKoreanList")
public class GameKoreanListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GameKoreanListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/game/gamelist/GameKoreanList.jsp").forward(request, response);
