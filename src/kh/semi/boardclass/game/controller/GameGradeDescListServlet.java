 ...
 */
@WebServlet("/GameGradeDescList")
public class GameGradeDescListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GameGradeDescListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/game/gamelist/GameGradeDescList.jsp").forward(request, response);
